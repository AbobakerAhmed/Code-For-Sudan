...
import 'package:pc_apps/main_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _performLogin() {
    ...
    HospitalManager manager = HospitalManager(
      "محمد أحمد خالد",
      "0123456789",
      "123123",
      'الخرطوم',
      ...
      "النو التعليمي",
        Hospital(
            ...
            "",
            "099999999999",
            [Department(name: "الباطنية", doctors: ["د. محمد أحمد", "د. خالد بتاع الباطنية"]),Department(name: "العظام", doctors: ["د. عبير عمر", "د. بهاء الدين موسى"])]
        ),
    );

    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => HomeScreen(manager: manager)),
    );
