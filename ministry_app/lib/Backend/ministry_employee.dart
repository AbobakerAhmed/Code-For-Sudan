...
class MinistryEmployee extends Person {
      ...
      for (final EpidemicRecord record in report.getData()) {
        ...
        if (mergedRecordsMap.containsKey(epidemicName)) {
          ...
          final int newCurrentPatientsMalesUnder5 =
              existingRecord.getCurrentPatientsMaleUnder5() +
              record.getCurrentPatientsMaleUnder5();
          ...
          final int newCurrentPatientsMalesAbove5 =
              existingRecord.getCurrentPatientsMaleAbove5() +
              record.getCurrentPatientsMaleAbove5();
          ...
          final int newNewCasesMalesUnder5 =
              existingRecord.getNewCasesMalesUnder5() +
              record.getNewCasesMalesUnder5();
          final int newNewCasesFemalesUnder5 =
              existingRecord.getNewCasesFemalesUnder5() +
              record.getNewCasesFemalesUnder5();
          final int newNewCasesMalesAbove5 =
              existingRecord.getNewCasesMalesAbove5() +
              record.getNewCasesMalesAbove5();
          final int newNewCasesFemalesAbove5 =
              existingRecord.getNewCasesFemalesAbove5() +
              record.getNewCasesFemalesAbove5();

          final int newDeathCasesMalesUnder5 =
              existingRecord.getDeathCasesMalesUnder5() +
              record.getDeathCasesMalesUnder5();
          final int newDeathCasesFemalesUnder5 =
              existingRecord.getDeathCasesFemalesUnder5() +
              record.getDeathCasesFemalesUnder5();
          final int newDeathCasesMalesAbove5 =
              existingRecord.getDeathCasesMalesAbove5() +
              record.getDeathCasesMalesAbove5();
          final int newDeathCasesFemalesAbove5 =
              existingRecord.getDeathCasesFemalesAbove5() +
              record.getDeathCasesFemalesAbove5();
      ...
      for (final ClinicalRecord record in report.getData()) {
        ...
        if (mergedRecordsMap.containsKey(departmentName)) {
          ...
          final ClinicalRecord existingRecord =
              mergedRecordsMap[departmentName]!;
          final int newOutpatients =
              existingRecord.getOutPatients() + record.getOutPatients();
          final int newAdmissions =
              existingRecord.getAdmissions() + record.getAdmissions();
          final int newInpatientCount =
              existingRecord.getInpatientCount() + record.getInpatientCount();
          final int newDischarges =
              existingRecord.getDischarges() + record.getDischarges();
          final int newSuccessfulSurgeries =
              existingRecord.getSuccessfulSurgeries() +
              record.getSuccessfulSurgeries();
  ...
  static MinistryEmployee fromJson({
    required Map<String, dynamic> MinistryEmp,
  }) => MinistryEmployee(
